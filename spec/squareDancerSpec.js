describe("squareDancer", function() {
  ...
  it("should have a step function that makes it into a square", function() {
    sinon.spy(squareDancer, 'animateBorderRadius');
    sinon.spy(squareDancer, 'animateBorderWidth');
    squareDancer.step();
    expect(squareDancer.animateBorderRadius.called).to.be.true;
    expect(squareDancer.animateBorderWidth.called).to.be.true;
  });
